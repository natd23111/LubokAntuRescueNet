...
class _MapWarningsScreenState extends State<MapWarningsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        final warningsProvider = Provider.of<WarningsProvider>(
          context,
          listen: false,
        );
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: FlutterMap(
                            ...
                            options: MapOptions(
                              initialCenter:
                                  warningsProvider.currentPosition != null
                                  ? LatLng(
                                      warningsProvider
                                          .currentPosition!
                                          .latitude,
                            ...
                            children: [
                              ...
                              if (warningsProvider.warnings.isNotEmpty)
                                MarkerLayer(
                                  markers: warningsProvider.warnings.map((
                                    warning,
                                  ) {
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(
                                  '${warningsProvider.activeWarningsCount}',
                                  style: TextStyle(
                                    color: Colors.red,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 12,
                          ...
                          if (warningsProvider.isLoading)
                            ...
                            Column(
                              spacing: 12,
                              children: warningsProvider.warnings.map((
                                warning,
                              ) {
  ...
  List<Widget> _buildWarningMarkers(WarningsProvider warningsProvider) {
    return warningsProvider.warnings.map((warning) {
      ...
      final position =
          positions[warningsProvider.warnings.indexOf(warning) %
              positions.length];
